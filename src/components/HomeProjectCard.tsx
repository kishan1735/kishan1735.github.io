...
function HomeProjectCard({
  ...
  return (
    <div className="bg-blue-400 rounded-sm inline-block w-fit h-[520px]">
      <a
        href={path}
        target="_blank"
        className="border-4 border-white text-white font-display inline-block h-[520px] bg-black hover:-translate-2 rounded-sm"
      >
